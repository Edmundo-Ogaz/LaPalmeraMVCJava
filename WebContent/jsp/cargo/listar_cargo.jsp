	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="47"><button type="button" onClick="window.open('listar_cargo.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="cargo.jsp">
					<input type="submit" name="cargo" value="Cargo"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				<tr><th>C&oacute;digo Cargo</th><th>Nombre</th></tr>
