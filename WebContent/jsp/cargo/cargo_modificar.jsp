...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el c&oacute;digo del Cargo.");
...
var checkOK = "0123456789";
  ...
  if (!allValid) {
    alert("Escriba s&oacute;lo n&uacute;meros en el campo \"C&oacute;digo\".");
    formulario.codigo.focus();
    return (false);
  }    
...
<table>
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Cargo</h1></td>
				<td width="64"><button type="button" onClick="window.open('cargo.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_cargo.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_cargo.jsp">
	...
	<form method = "get" name = "cargo_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaCargo">
  				<input name="codigo" type="hidden" value="<%=cargo.getCodigoCargo()%>">
  				<table>
				<tr>
					<td width="133">C&oacute;digo Cargo :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=cargo.getCodigoCargo()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=cargo.getNombreCargo()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
