...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaCargo">
  				<input name="codigo" type="hidden" value="<%=cargo.getCodigoCargo()%>">
  				<table>
				<tr>
			  			<td width="116">C&oacute;digo Cargo :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=cargo.getCodigoCargo()%>" disabled="disabled"/></td>
				<tr>
