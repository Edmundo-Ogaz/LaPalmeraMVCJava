	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_cargo.jsp" onSubmit="return validar(this)">
  				<table>
				<tr>
				  <td width="133">C&oacute;digo Cargo :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=cargo.getCodigoCargo()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=cargo.getNombreCargo()%>" disabled="disabled"/></td>
    			</tr>
    			<tr>
			<td></td>
	        <td></td>
	  ...
	  <input name="cod" type="hidden" value="<%=cargo.getCodigoCargo()%>">
    </tr>
  </table>
</form>
	</td>
