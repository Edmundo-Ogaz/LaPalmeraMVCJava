...
function validar(formulario) {
  ...
  if (document.formulario.cantidad.value < 1) {
    alert("La Cantidad Ingresada no es Valida.");
    document.formulario.cantidad.focus();
    return (false);
  }
  
  //alert (document.formulario.cantidad.value + " > " + document.formulario.saldoporfabricar.value);
  //alert (document.formulario.saldoporfabricar.value);
   if (parseInt(document.formulario.cantidad.value) > parseInt(document.formulario.saldoporfabricar.value)) {
...
<input type="submit" name="Enviar" value="Enviar Captura"/>
