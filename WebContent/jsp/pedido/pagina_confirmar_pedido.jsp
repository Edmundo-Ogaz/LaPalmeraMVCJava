...
<table>
  ...
  <table>
	...
	<td><input name="numero pedido" type="text"></td>
	</tr>
	<tr>
	...
	<tr>
	  <td><h3>Datos de la Entrega</h3></td>
    </tr>
    <tr>
	<td>Dirección</td>
	...
	<td><input name="por confirmar" type="radio" value="true"></td>
	<td><input name="confirmado" type="radio" value="true">
	</tr>
	<tr>
	<td></td><td></td>
