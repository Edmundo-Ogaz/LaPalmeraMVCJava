...
<body>
<form name="formulario" action = "/LaPalmera/jsp/ControlListaOrdenFabricacionCapturaProduccion.jsp" onSubmit="return validar(this)" target="_self">
...
<input type=submit name=Enviar value = 'Captura Producción'>
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=FilCapturaProduccion.jsp&titulo=Filtrado Captura Producción','_self')">Volver</button>
