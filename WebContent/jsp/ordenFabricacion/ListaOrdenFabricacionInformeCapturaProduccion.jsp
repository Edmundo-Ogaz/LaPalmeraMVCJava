...
<body>
<form name="formulario" action = "/LaPalmera/jsp/ControlListaOrdenFabricacionInformeCapturaProduccion.jsp" onSubmit="return validar(this)" target="_self">
...
<input type=submit name=Enviar value = 'Consultar Captura Producción'>
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=FilInformeCapturaProduccion.jsp&titulo=Filtrado Informe Captura Producción','_self')">Volver</button>
