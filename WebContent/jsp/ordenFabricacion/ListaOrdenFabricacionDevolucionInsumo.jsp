...
<body>
<form name="formulario" action = "/LaPalmera/jsp/ControlListaOrdenFabricacionDevolucionInsumo.jsp" onSubmit="return validar(this)" target="_self">
...
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=FilDevolucionInsumo.jsp&titulo=Filtrado Devolución de Insumos','_self')">Volver</button>
