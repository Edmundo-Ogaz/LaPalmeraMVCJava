...
<%--}--%>
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=FilInformeOrdenFabricacion.jsp&titulo=Filtrado Informe Orden Fabricación','_self')">Filtro</button>
