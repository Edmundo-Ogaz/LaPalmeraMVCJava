...
<body>
<form name="formulario" action = "/LaPalmera/jsp/ControlListaOrdenFabricacionEntregaInsumo.jsp" onSubmit="return validar(this)" target="_self">
...
<input type=submit name=Enviar value = 'Entrega Insumos'>
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=FilEntregaInsumo.jsp&titulo=Filtrado Entrega de Insumos','_self')">Volver</button>
