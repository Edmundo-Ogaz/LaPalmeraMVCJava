...
<body>
<form name="formulario" action = "/LaPalmera/jsp/ControlListaOrdenFabricacionInformeDevolucionInsumo.jsp" onSubmit="return validar(this)" target="_self">
...
<input type=submit name=Enviar value = 'Consultar Devolución Insumos'>
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=FilInformeDevolucionInsumo.jsp&titulo=Filtrado Informe Devolución de Insumos','_self')">Volver</button>
