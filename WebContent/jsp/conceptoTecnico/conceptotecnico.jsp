	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td><form action="consultar_conceptotecnico.jsp" method="get" onSubmit = "return validar(this)" name="conceptotecnico">
				<table width="412">
					<tr>
			  			<td width="182">Código Concepto Técnico :</td>
      					<td width="149"><input name = "codigo" type="type"/></td>
						<td width="65"><input type="submit" name="buscar" value="Buscar"/></td>
	  				</tr>
				</table>
				</form></td>
				</tr>
