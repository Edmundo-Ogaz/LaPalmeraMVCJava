	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Concepto Tecnico</h1></td>
				...
				<!--td width="50"><form action="conceptotecnico.jsp">
					<input type="submit" name="conceptotecnico" value="Concepto Tecnico"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				...
				<%Vector vecRep;
				vecRep = manConceptoTecnico.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	ConceptoTecnico conceptoTecnico = (ConceptoTecnico) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=conceptoTecnico.getCodigoConceptoTecnico()%></td>
      					<td width="110" align="left">&nbsp;<%=conceptoTecnico.getNombreConceptoTecnico()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
