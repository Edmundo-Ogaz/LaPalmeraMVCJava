...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaConceptoTecnico">
  				<input name = "codigo" type="hidden" value="<%=conceptoTecnico.getCodigoConceptoTecnico()%>"/>
				<table>
				<tr>
			  			<td width="116">Código Concepto Técnico :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=conceptoTecnico.getCodigoConceptoTecnico()%>" disabled="disabled"/></td>
				<tr>
