	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_conceptotecnico.jsp" onSubmit = "return validar(this)">
  				<input name = "cod" type="hidden" value="<%=conceptoTecnico.getCodigoConceptoTecnico()%>" />
				<table>
				<tr>
					<td width="133">Código Concepto Técnico :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=conceptoTecnico.getCodigoConceptoTecnico()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=conceptoTecnico.getNombreConceptoTecnico()%>" disabled="disabled"/></td>
    			</tr>
			<tr>
			<td></td>
	        <td></td>
