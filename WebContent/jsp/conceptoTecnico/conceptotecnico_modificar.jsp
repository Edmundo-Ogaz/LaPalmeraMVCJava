...
var checkOK = "0123456789";
  ...
  if (formulario.nombre.value.length < 1) {
    alert("Escriba el nombre del Concepto Tecnico.");
...
<table>
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Concepto Técnico</h1></td>
				<td width="64"><button type="button" onClick="window.open('conceptotecnico.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_conceptotecnico.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_conceptotecnico.jsp">
	...
	<form method = "get" name = "funcionario_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaConceptoTecnico">
  				<input name = "codigo" type="hidden" value="<%=conceptoTecnico.getCodigoConceptoTecnico()%>"/>
				<table>
				<tr>
					<td width="133">Código Concepto Técnico :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=conceptoTecnico.getCodigoConceptoTecnico()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=conceptoTecnico.getNombreConceptoTecnico()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
