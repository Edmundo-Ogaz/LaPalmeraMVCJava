...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaOtraCaracteristica">
  				<input name = "codigo" type="hidden" value="<%=otraCaracteristica.getCodigoOtraCaracteristica()%>"/>
				<table>
				<tr>
			  			<td width="116">Código Otra Caracteristica :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=otraCaracteristica.getCodigoOtraCaracteristica()%>" disabled="disabled"/></td>
				<tr>
