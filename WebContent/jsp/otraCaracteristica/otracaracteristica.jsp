	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td><form action="consultar_otracaracteristica.jsp" method="get" onSubmit = "return validar(this)" name="otracaracteristica">
				<table width="418">
					<tr>
			  			<td width="190">Código Otra Caracteristica :</td>
      					<td width="153"><input name = "codigo" type="type"/></td>
						<td width="59"><input type="submit" name="buscar" value="Buscar"/></td>
	  				</tr>
				</table>
				</form></td>
				</tr>
