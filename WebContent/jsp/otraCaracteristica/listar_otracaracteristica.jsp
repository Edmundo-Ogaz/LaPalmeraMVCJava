	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="47"><button type="button" onClick="window.open('listar_otracaracteristica.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="otracaracteristica.jsp">
					<input type="submit" name="otracaracteristica" value="Otra Caracteristica"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				...
				<%while (enumRep.hasMoreElements())
			    {
			    	...
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=otraCaracteristica.getCodigoOtraCaracteristica()%></td>
      					<td width="110" align="left">&nbsp;<%=otraCaracteristica.getNombreOtraCaracteristica()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
