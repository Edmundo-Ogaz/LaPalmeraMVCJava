...
<!--table background="images/pasteleria_fondo3.3.png" cellpadding="0" cellspacing="0" width="752"  height="582"class="Middle"-->
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Otra Caracteristica</h1></td>
				<td width="64"><button type="button" onClick="window.open('otracaracteristica.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_otracaracteristica.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_otracaracteristica.jsp">
	...
	<form method = "get" name = "otracaracteristica_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaOtraCaracteristica">
  				<input name = "codigo" type="hidden" value="<%=otraCaracteristica.getCodigoOtraCaracteristica()%>"/>
				
				<table width="604">
				<tr>
					<td width="188">C&oacute;digo Otra Caracteristica :</td>
			      <td width="258"><input name = "codigo2" type="type" value="<%=otraCaracteristica.getCodigoOtraCaracteristica()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="188">Nombre :</td>
	   			    <td width="258"><input name = "nombre" type="type" size="40" value="<%=otraCaracteristica.getNombreOtraCaracteristica()%>"/></td>
				</tr>
    			<tr>
			<td></td>
	        <td></td>
	  <td width="69"><input name="grabar" value="Grabar" type="submit"></td>
	  <td width="69"><input name="cancelar" value="Cancelar" type="submit"></td>
    </tr>
  </table>
		</form>		</td>
	</tr>				
