	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_otracaracteristica.jsp" onSubmit="return validar(this)">
  				<input name = "cod" type="hidden" value="<%=otraCaracteristica.getCodigoOtraCaracteristica()%>"/>
				<table width="604">
				<tr>
					<td width="195">Código Otra Caracteristica :</td>
   				  <td width="259"><input name = "codigo" type="type" value="<%=otraCaracteristica.getCodigoOtraCaracteristica()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="195">Nombre :</td>
	   			  <td width="259"><input name = "nombre" type="type" size="40" value="<%=otraCaracteristica.getNombreOtraCaracteristica()%>" disabled="disabled"/></td>
    			</tr>
    			<tr>
			<td></td>
	        <td></td>
	  <td width="68"><input name="modificar" value="Modificar" type="submit"></td>
	  <td width="62"><input name="eliminar" value="Eliminar" type="submit"></td>
    </tr>
  </table>
</form>
