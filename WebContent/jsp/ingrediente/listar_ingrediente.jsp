	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="50"><form action="ingrediente.jsp">
					<input type="submit" name="ingrediente" value="Ingrediente"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				<tr><th>Producto</th><th>Insumo</th><th>Carga</th><th>Cantidad</th></tr>
				<%ManejadorIngrediente manIngrediente = new ManejadorIngrediente();%>
				<%Vector vecRep;
				vecRep = manIngrediente.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	Ingrediente ingrediente = (Ingrediente) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=ingrediente.getCodigoProducto()%></td>
      					<td width="110" align="right">&nbsp;<%=ingrediente.getCodigoInsumo()%></td>
						<td width="10" align="right">&nbsp;<%=ingrediente.getCarga()%></td>
						<td width="10" align="right">&nbsp;<%=ingrediente.getCantidadInsumo()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
