...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaIngrediente">
  				<input name = "producto" type="hidden" value="<%=ingrediente.getCodigoProducto()%>"/>
				<table>
				<tr>
			  			<td width="116">Código Producto :</td>
						<td width="150"><input name = "producto2" type="type" value="<%=ingrediente.getCodigoProducto()%>" disabled="disabled"/></td>
				<tr>
			      <td width="153">Código Insumo :</td>
			   ...
			   <td><SELECT size="1" name="insumo">
			    ...
			    <%}%>
	   			...
	   			<!--td width="238"><input name = "insumo" type="type" size="40"/></td-->
    			</tr>
    		<tr>
			<td>Carga</td>
			   <td width="238"><input name = "carga" type="type" size="40"/></td>
			</tr>
			<tr>
			<td>Cantidad Insumo</td>
			<td><input name = "cantidadinsumo" type="type" /></td>
			</tr>
			<tr>
			<td></td>
	        <td></td>
