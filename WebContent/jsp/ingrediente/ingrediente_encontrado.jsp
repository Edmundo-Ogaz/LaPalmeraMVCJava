	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_ingrediente.jsp"  onSubmit="return validar(this)">
			   ...
			   <td><SELECT size="1" name="insumo" disabled="disabled">
			    ...
			    <%}%>
	   			  ...
	   			  <!--td width="242"><input name = "insumo" type="type" size="40" value="<%=ingrediente.getCodigoInsumo()%>" disabled="disabled"/></td-->
    			</tr>
    			<tr>
					<td>Carga :</td>
				  <td width="242"><input name = "carga" type="type" size="40" value="<%=ingrediente.getCarga()%>" disabled="disabled"/></td>
				</tr>
				<tr>
				<td>Cantidad Insumo :</td>
				<td width="242"><input name = "cantidadinsumo" type="type" size="40" value="<%=ingrediente.getCantidadInsumo()%>" disabled="disabled"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
