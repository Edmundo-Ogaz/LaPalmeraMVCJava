...
<%}else{%>
	<%if (usuario.getCodigoGrupo().equals("2")) {%>
		<script language="JavaScript" src="menu_bodeguero.js">
		</script>
	<%}else{%>
		<%if (usuario.getCodigoGrupo().equals("3")) {%>
			<script language="JavaScript" src="menu_supervisor.js">
			</script>
		<%}%>
	<%}%>
<%}%>		
