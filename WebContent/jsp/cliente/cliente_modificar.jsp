...
<table>
	...
	<form method = "get" name = "cliente_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaCliente">
				...
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=cliente.getNombreCliente()%>"/></td>
    			</tr>
    			<tr>
					<td>Direcci&oacute;n :</td>
				  <td width="242"><input name = "direccion" type="type" size="40" value="<%=cliente.getDireccionCliente()%>"/></td>
				</tr>
				<tr>
				<td>Comuna :</td>
			   ...
			   <%}%>
				...
				<!--td width="242"><input name = "comuna" type="type" size="40" value="<%=cliente.getCodigoComuna()%>"/></td-->
				</tr>
				<tr>
				  <td>Fecha Nacimiento :</td>
				  <td width="242"><input name = "fechanacimiento" type="type" size="40" value="<%=cliente.getFechaNacimientoCliente()%>"/></td>

			</tr>
			<tr>
				  <td>Tel&eacute;fono :</td>
				  <td width="242"><input name = "telefono" type="type" size="40" value="<%=cliente.getTelefonoCliente()%>"/></td>

			</tr>
			<tr>
				  <td>E-Mail :</td>
				  <td width="242"><input name = "email" type="type" size="40" value="<%=cliente.getEmailCliente()%>"/></td>

			</tr>
			<tr>
				  <td>P&aacute;gina Web :</td>
				  <td width="242"><input name = "paginaweb" type="type" size="40" value="<%=cliente.getPaginaWebCliente()%>"/></td>
			...
			<tr>
			   ...
			   <%}%>
			    <%}%>
				  ...
				  <!--td width="242"><input name = "tipocliente" type="type" size="40" value="<%=cliente.getCodigoTipoCliente()%>"/></td-->

			</tr>
			<tr>
				  <td>Observaci&oacute;n :</td>
				  <td width="242"><input name = "observacion" type="type" size="40" value="<%=cliente.getObservacionCliente()%>"/></td>
