	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="47"><button type="button" onClick="window.open('listar_producto.jsp','self')">Listar</button></td-->
				...
				<table border="1">
				<tr><th>C&oacute;digo</th><th>Nombre</th><th>Familia</th><th>Subfamilia</th><th>Otra Caracter&iacute;stica</th><th>Unidad Medida</th><th>Stock Cr&iacute;tico</th><th>Valor Costo</th><th>Valor Venta</th><th>Preparaci&oacute;n</th><th>Producto Semielaborado</th><th>foto</th><th>Observaci&oacute;n</th></tr>	
				...
				<%while (enumRep.hasMoreElements())
			    {
			    	...
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=producto.getCodigoProducto()%></td>
      					<td width="110" align="left">&nbsp;<%=producto.getNombreProducto()%></td>
						<td width="10" align="right">&nbsp;<%=producto.getCodigoFamilia()%></td>
						<td width="10" align="right">&nbsp;<%=producto.getCodigoSubfamilia()%></td>
						<td width="10" align="right">&nbsp;<%=producto.getCodigoOtraCaracteristica()%></td>
						<td width="10" align="right">&nbsp;<%=producto.getCodigoUnidadMedida()%></td>
						<td width="10" align="right">&nbsp;<%=producto.getStockCriticoProducto()%></td>
						<td width="50" align="right">&nbsp;<%=producto.getValorCostoProducto()%></td>
						<td width="50" align="right">&nbsp;<%=producto.getValorVentaProducto()%></td>
						<td width="100" align="left">&nbsp;<%=producto.getPreparacionProducto()%></td>
						<td width="10" align="left">&nbsp;<%=producto.getProductoSemielaborado()%></td>
						<td width="80" align="left">&nbsp;<%=producto.getFotoProducto()%></td>						
						<td width="110" align="left">&nbsp;<%=producto.getObservacionProducto()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
