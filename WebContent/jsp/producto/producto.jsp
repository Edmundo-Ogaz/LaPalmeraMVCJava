	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				<tr>
					<td width="673" height="5%"></td>
				</tr>
				<tr>
				<td valign="top">
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Producto</h1></td>
				...
				<table>
				<tr>
				<td><form action="consultar_producto.jsp" method="get" onSubmit = "return validar(this)" name="producto">
				<table>
					<tr>
