...
var checkOK = "0123456789";
  ...
  if (formulario.dia.value.length < 1) {
    alert("Escriba el dia de la fecha de venciniento.");
    formulario.dia.focus();
    return (false);
  }
  
    if (formulario.mes.value.length < 1) {
    alert("Escriba el Mes de la fecha de venciniento.");
    formulario.mes.focus();
    return (false);
  }

  if (formulario.año.value.length < 1) {
    alert("Escriba el Año de la fecha de venciniento.");
...
if (formulario.ubicacion.value.length < 1) {
    alert("Escriba la ubicacion del producto.");
...
<table>
  ...
  <table>
	...
	<tr>
      ...
      <td>Código:</td>
      <td><input name="codigo" type="text" size="10"></td>
	  <td>Nombre:</td>
	  <td><input name="nombre" type="text" size="30" disabled="disabled"></td>
	  <td>Stock Actual:</td>
      <td><input name="stockactual" type="text" size="5" disabled="disabled"></td>
     </tr>
	 </table>
	 </td>
     </tr>
	...
	<br>
	  ...
	  <tr>
	   ...
	   <tr>
	   <td>Día<select name="dia">
		<option>
		<option>1
		<option>2
		<option>3
		</select>Mes<select name="mes">
		<option>
		<option>1
		<option>2
		<option>3
		</select>Año<select name="año">
		<option>
		<option>1
		<option>2
		<option>3
	  ...
	  <tr>
	  <td width="414"></td>
	  <td width="233"><input name="agregarubucacion" value="Agregar Ubicación" type="button"></td>
	  </tr>
	  </table>
	  </td>
	  </tr>
	...
	<tr>
	<td width="454"></td>
       <td width="117"><input name="ingresoproducto" value="Ingreso Producto" type="submit"></td>
	   <td width="72"><input name="cancelar" value="Cancelar" type="reset"></td>
	   </tr>
	   </table>
	   </td>
    </tr>
