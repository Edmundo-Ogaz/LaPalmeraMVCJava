...
function validar(formulario) {
  if (formulario.numeropedido.value.length < 1) {
    alert("Escriba el número del pedido.");
    formulario.numeropedido.focus();
    return (false);
  }
   
 var checkOK = "0123456789";
  var checkStr = formulario.numeropedido.value;
  var allValid = true;
  var decPoints = 0;
  var allNum = "";
  ...
  if (!allValid) {
    alert("Escriba sólo números en el campo \"Número de Pedido\".");
    formulario.numeropedido.focus();
    return (false);
  } 
  return (true);
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<tr>
				<td valign="top">
				<h1>Programar Producción</h1> 
				<!--form action="custom_error.jsp" method="post"-->
				<form method = "POST" name = "registro" onSubmit = "return validar(this)" action = "Listar.jsp">
  <table>
    <tr>
	<td><h3>Datos del Pedido</h3></td>
	</tr>
	<tr>
	  <td>Orden Fabricación</td>
	  <td><input name="numeropedido" type="text" size="10"></td>
	  <td>Hora de Entrega:</td>
	  <td><input name="horaentrega" type="text"></td>
	  </tr>
	  <tr>
	  <td></td>
	  <td></td>
	  <td>Fecha de Entrega:</td>
	  <td><input name="fechaentrega" type="text"></td>
	  </tr>
	  <tr>
	  <td><br /></td>
	  </tr>
	  ...
	  <td>Comuna</td>
	  <td><input name="comuna" type="text"></td>
	  </tr>
	  <tr>
	  <td>telefono</td>
      ...
      <tr>
	  <td colspan="2"><h3>Datos del Producto</h3></td>
	  </tr>
	  <tr>
	  <td>Producto</td>
 	  <td>Cantidad</td>
	  ...
	  <td><input name="lineaproduccion" type="text"></td>
	  <td><select name="funcionario"   >
	  <option>
	  <option>funcionario 1
	  <option>funcionario 2
	  <option>Edmundo Ogaz Baltierra
	  </select></td>
	  </tr>
	  <tr>
	  ...
	  <tr>	
	   <td></td><td></td>
     <td><input name="programar" value="Programar" type="submit"></td>
