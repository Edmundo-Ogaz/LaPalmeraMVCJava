...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaComuna">
  				<input name = "codigo" type="hidden" value="<%=comuna.getCodigoComuna()%>"/>
				<table>
				<tr>
			  			<td width="116">C&oacute;digo Comuna :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=comuna.getCodigoComuna()%>" disabled="disabled"/></td>
				<tr>
