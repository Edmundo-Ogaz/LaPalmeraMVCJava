...
<table>
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_comuna.jsp" onSubmit="return validar(this)">
  				<table>
				<tr>
					<td width="133">C&oacute;digo Comuna :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=comuna.getCodigoComuna()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=comuna.getNombreComuna()%>" disabled="disabled"/></td>
    			</tr>
    			<tr>
					<td>Ciudad :</td>
			   ...
			   <td><SELECT size="1" name="ciudad" disabled="disabled">
				  <%while (enumCiudad.hasMoreElements())
			    {
				 ...
				 <OPTION  selected VALUE="<%=ciudad.getCodigoCiudad()%>"> <%=ciudad.getNombreCiudad()%></OPTION>					   				<%}else{%>
				 <OPTION VALUE="<%=ciudad.getCodigoCiudad()%>"> <%=ciudad.getNombreCiudad()%></OPTION>
			    <%}%>
			    <%}%>
				</SELECT></td>
				  <!--td width="242"><input name = "ciudad" type="type" size="40" value="<%=comuna.getCodigoCiudad()%>" disabled="disabled"/></td-->
				</tr>
			<tr>
			<td></td>
	        <td></td>
    ...
    <input name="cod" type="hidden" value="<%=comuna.getCodigoComuna()%>"/>
    </tr>
  </table>
</form>
