	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="50"><form action="comuna.jsp">
					<input type="submit" name="comuna" value="Comuna"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				<tr><th>C&oacute;digo</th><th>Nombre</th><th>Ciudad</th></tr>
				<%ManejadorComuna manComuna = new ManejadorComuna();%>
				<%Vector vecRep;
				vecRep = manComuna.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	Comuna comuna = (Comuna) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="left">&nbsp;<%=comuna.getCodigoComuna()%></td>
      					<td width="110" align="right">&nbsp;<%=comuna.getNombreComuna()%></td>
						<td width="10" align="right">&nbsp;<%=comuna.getCodigoCiudad()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
