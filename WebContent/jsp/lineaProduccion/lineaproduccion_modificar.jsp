...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el código de la Linea Producción.");
...
var checkOK = "0123456789";
  ...
  if (formulario.nombre.value.length < 1) {
    alert("Escriba el nombre de la Linea Producción.");
...
<table>
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Línea Producción</h1></td>
				<td width="64"><button type="button" onClick="window.open('lineaproduccion.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_lineaproduccion.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_lineaproduccion.jsp">
	...
	<form method = "get" name = "lineaproduccion_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaLineaProduccion">
  				<input name = "codigo" type="hidden" value="<%=lineaProduccion.getCodigoLineaProduccion()%>"/>
				<table width="591">
				<tr>
					<td width="189">Código Linea Producción :</td>
   				  <td width="254"><input name = "codigo2" type="type" value="<%=lineaProduccion.getCodigoLineaProduccion()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="189">Nombre :</td>
   			      <td width="254"><input name = "nombre" type="type" size="40" value="<%=lineaProduccion.getNombreLineaProduccion()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
	  <td width="56"><input name="grabar" value="Grabar" type="submit"></td>
	  <td width="72"><input name="cancelar" value="Cancelar" type="submit"></td>
    </tr>
  </table>
		</form>
