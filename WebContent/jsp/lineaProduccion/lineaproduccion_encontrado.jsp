	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_lineaproduccion.jsp" onSubmit = "return validar(this)">
  				<input name = "cod" type="hidden" value="<%=lineaProduccion.getCodigoLineaProduccion()%>" />
				<table width="592">
				<tr>
					<td width="193">Código Línea Producción :</td>
   				  <td width="246"><input name = "codigo" type="type" value="<%=lineaProduccion.getCodigoLineaProduccion()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="193">Nombre :</td>
	   			  <td width="246"><input name = "nombre" type="type" size="40" value="<%=lineaProduccion.getNombreLineaProduccion()%>" disabled="disabled"/></td>
    			</tr>
			<tr>
			<td></td>
	        <td></td>
	  <td width="68"><input name="modificar" value="Modificar" type="submit"></td>
	  <td width="65"><input name="eliminar" value="Eliminar" type="submit"></td>
    </tr>
  </table>
</form>
