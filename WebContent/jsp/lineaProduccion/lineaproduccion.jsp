...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el Código de la Línea Producción.");
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td><form action="consultar_lineaproduccion.jsp" method="get" onSubmit = "return validar(this)" name="lineaproduccion">
				<table width="417">
					<tr>
			  			<td width="183">Código Línea Producción :</td>
      					<td width="157"><input name = "codigo" type="type"/></td>
						<td width="61"><input type="submit" name="buscar" value="Buscar"/></td>
	  				</tr>
				</table>
				</form></td>
				</tr>
