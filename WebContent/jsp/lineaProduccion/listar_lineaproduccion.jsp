	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Linea Producción</h1></td>
				<td width="64"><button type="button" onClick="window.open('lineaproduccion.jsp','_self')">Atr&aacute;s</button></td>
				<!--td width="47"><button type="button" onClick="window.open('listar_lineaproduccion.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="lineaproduccion.jsp">
					<input type="submit" name="lineaproduccion" value="Linea Producción"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				...
				<%Vector vecRep;
				vecRep = manLineaProduccion.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	LineaProduccion lineaProduccion = (LineaProduccion) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=lineaProduccion.getCodigoLineaProduccion()%></td>
      					<td width="110" align="left">&nbsp;<%=lineaProduccion.getNombreLineaProduccion()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
