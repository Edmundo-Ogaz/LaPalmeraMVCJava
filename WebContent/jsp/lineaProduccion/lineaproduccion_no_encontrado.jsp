...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaLineaProduccion">
  				<input name = "codigo" type="hidden" value="<%=lineaProduccion.getCodigoLineaProduccion()%>"/>
				<table width="557">
				<tr>
			  			<td width="171">Código Líne Producción :</td>
				  <td width="245"><input name = "codigo2" type="type" value="<%=lineaProduccion.getCodigoLineaProduccion()%>" disabled="disabled"/></td>
				<tr>
			      <td width="171">Nombre :</td>
	   			<td width="245"><input name = "nombre" type="type" size="40"/></td>
    			</tr>
   			<tr>
			<td></td>
	        <td></td>
