...
<td>
&nbsp;
<%cantidadinsumo = String.valueOf((Float.parseFloat(detallePedido.getCantidadProducto())*Float.parseFloat(insumo.getPesoInsumo()))/Float.parseFloat(ingrediente.getCarga()));%>
...
{%>
<font color="#0000FF"><%=stockdisponible.substring(0,cantidadinsumo.indexOf(".")+3)%></font>
<%}else{%>
<font color="#FF0000"><%=stockdisponible.substring(0,cantidadinsumo.indexOf(".")+3)%></font>
<%}%>	  
</td>
<td>
&nbsp;
