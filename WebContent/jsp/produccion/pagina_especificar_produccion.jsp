...
function validar(formulario) {
  if (formulario.ordenfabricacion.value.length < 1) {
    alert("No a ingresado la Orden de Fabricación.");
  ...
  if (!allValid) {
    alert("Escriba sólo números en la oden de fabricación.");
    formulario.ordenfabricacion.focus();
    return (false);
  }
  
 if (formulario.funcionario.value.length < 1) {
    alert("No a ingresado el funcionario encargado.");
    formulario.funcionario.focus();
    return (false);
  }
  
  if (formulario.lineaproduccion.value.length < 1) {
    alert("No a ingresado la linea de producción.");
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<tr>
				<td valign="top">
				<h1>Especificar Producción</h1>
				<!--form action="custom_error.jsp" method="post"-->
				<form action="listar.jsp" method="post" name = "registro" onSubmit = "return validar(this)">
  <table>
   <tr>
	  <td><h3>Datos Orden de Fabricación</h3></td>
    </tr>
    <tr>
	<td>Orden de Fabricación
	  <input type="text" name="ordenfabricacion"></td>
	<td>Fecha de Entrega<input type="text" name="fechaentrega"></td>
	</tr>
	<tr>
	  <td>Producto:<input type="text" name="textfield"></td>
      <td>Hora de Entrega<input type="text" name="textfield"></td>
    </tr>
    <tr>
	<td>Cantidad<input type="text" name="textfield"></td>
	</tr>
	<tr>
      <td>Funcionario Encargado 
	  <SELECT name="funcionario">
        <OPTION>
		<OPTION>funcionario 1
		<OPTION>funcionario 2
        <OPTION>funcionario 3
        <OPTION>funcionario 4
      </SELECT></td>
	</tr>
	<tr>
      <td>Linea Producción 
	 ...
	 <tr>
	 <td></td>
	   <td><input name="tomarproduccion" value="Tomar Producción" type="submit"></td>
	  <td><input name="cancelar" value="Cancelar" type="reset"></td>
    </tr>
  </table>
</form>
				</td>
