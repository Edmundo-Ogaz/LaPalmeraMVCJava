...
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=ListaOrdenFabricacionDevolucionInsumo.jsp&titulo=Devolución Insumos por Orden Fabricación&filordenfabricacion=<%=filordenfabricacion%>','_self')">Volver</button>
</form>
</body>
</html>
