...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaArea">
  				<input name = "codigo" type="hidden" value="<%=area.getCodigoArea()%>"/>
  				<table>
				<tr>
			  			<td width="116">C&oacute;digo Area :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=area.getCodigoArea()%>" disabled="disabled"/></td>
				<tr>
