	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Area</h1></td>
				<td width="64"><button type="button" onClick="window.open('area.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_area.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_area.jsp">
					<input type="submit" name="listar" value="Listar"/>
				  </form></td-->
				</tr>
				</table>
				
				<jsp:useBean id="area" class="Area" scope="session"/>
	<form method = "get" name = "area_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaArea">
  				<input name = "codigo" type="hidden" value="<%=area.getCodigoArea()%>"/>
  				<table>
				<tr>
					<td width="133">C&oacute;digo Area :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=area.getCodigoArea()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=area.getNombreArea()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
