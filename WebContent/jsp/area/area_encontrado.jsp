	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<jsp:useBean id="area" class="cl.laPalmera.DTO.AreaDTO" scope="session"/>
				<form method = "get" action = "consultar_operacion_area.jsp" onSubmit="return validar(this)">
  				<table>
				<tr>
					<td width="133">C&oacute;digo Area :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=area.getCodigoArea()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=area.getNombreArea()%>" disabled="disabled"/></td>
    			</tr>
			<tr>
			<td></td>
	        <td></td>
	  ...
	  <td><input name="eliminar" value="Eliminar" type="submit"></td>
		<input name="cod" type="hidden" value="<%=area.getCodigoArea()%>">    
    </tr>
  </table>
</form>
