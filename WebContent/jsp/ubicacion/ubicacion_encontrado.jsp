	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_ubicacion.jsp">
  				<input name = "producto" type="hidden" value="<%=ubicacion.getCodigoProducto()%>"/>
				<table>
				<tr>
					<td width="133">Código Producto :</td>
   				  <td width="242"><input name = "producto2" type="type" value="<%=ubicacion.getCodigoProducto()%>" disabled="disabled" /></td>
				</tr>
				<tr>
			...
			<%Enumeration enumBodega = vecBodega.elements();%>
			   <td><SELECT size="1" name="bodega" disabled="disabled">
		   ...
		   <%}%>
	   			  ...
	   			  <!--td width="242"><input name = "bodega" type="type" size="40" value="<%=ubicacion.getCodigoBodega()%>" disabled="disabled"/></td-->
    			</tr>
    			<tr>
					<td>Tipo :</td>
				  <td width="242"><input name = "tipo" type="type" size="40" value="<%=ubicacion.getTipoEntidad()%>" disabled="disabled"/></td>
				</tr>
				<tr>
				<td>Fecha Ingreso :</td>
				<td width="242"><input name = "fechaingreso" type="type" size="40" value="<%=ubicacion.getFechaIngreso()%>" disabled="disabled"/></td>
				</tr>
				<tr>
				  <td>FechaVencimiento :</td>
				  <td width="242"><input name = "fechavencimiento" type="type" size="40" value="<%=ubicacion.getFechaVencimiento()%>" disabled="disabled"/></td>

			</tr>
			<tr>
				  <td>Cantidad :</td>
				  <td width="242"><input name = "cantidad" type="type" size="40" value="<%=ubicacion.getCantidad()%>" disabled="disabled"/></td>

			</tr>
			<tr>
				  <td>Observación :</td>
				  <td width="242"><input name = "observacion" type="type" size="40" value="<%=ubicacion.getObservacion()%>" disabled="disabled"/></td>
