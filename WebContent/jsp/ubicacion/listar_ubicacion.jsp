	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="50"><form action="ubicacion.jsp">
					<input type="submit" name="ubicacion" value="Ubicación"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				<tr><th>Producto</th><th>Bodega</th><th>Tipo</th><th>Fecha Ingreso</th><th>Frcha Vencimiento</th><th>Cantidad</th><th>Observación</th></tr>
				<%ManejadorUbicacion manUbicacion = new ManejadorUbicacion();%>
				<%Vector vecRep;
				vecRep = manUbicacion.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	Ubicacion ubicacion = (Ubicacion) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=ubicacion.getCodigoProducto()%></td>
      					<td width="110" align="right">&nbsp;<%=ubicacion.getCodigoBodega()%></td>
						<td width="10" align="left">&nbsp;<%=ubicacion.getTipoEntidad()%></td>
						<td width="10" align="right">&nbsp;<%=ubicacion.getFechaIngreso()%></td>
						<td width="10" align="right">&nbsp;<%=ubicacion.getFechaVencimiento()%></td>
						<td width="10" align="right">&nbsp;<%=ubicacion.getCantidad()%></td>
						<td width="10" align="left">&nbsp;<%=ubicacion.getObservacion()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
