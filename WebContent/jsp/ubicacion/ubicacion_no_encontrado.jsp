...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaUbicacion">
		   ...
		   <%}%>
	   			  ...
	   			  <!--td width="242"><input name = "bodega" type="type" size="40"/></td-->
    			</tr>
    			<tr>
					<td>Tipo :</td>
				  <td width="242"><input name = "tipo" type="type" size="40"/></td>
				</tr>
				<tr>
				<td>Fecha Ingreso :</td>
				<td width="242"><input name = "fechaingreso" type="type" size="40"/></td>
				</tr>
				<tr>
				  <td>FechaVencimiento :</td>
				  <td width="242"><input name = "fechavencimiento" type="type" size="40"/></td>

			</tr>
			<tr>
				  <td>Cantidad :</td>
				  <td width="242"><input name = "cantidad" type="type" size="40"/></td>
