	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_fichatecnica.jsp" onSubmit="return validar(this)">
  				<input name = "producto" type="hidden" value="<%=fichaTecnica.getCodigoProducto()%>"/>
				<input name = "conceptotecnico" type="hidden" size="40" value="<%=fichaTecnica.getCodigoConceptoTecnico()%>"/>
				<table>
				<tr>
			   ...
			   <td><SELECT size="1" name="conceptotecnico2" disabled="disabled">
			    ...
			    <%}%>
	   			  ...
	   			  <!--td width="242"><input name = "conceptotecnico2" type="type" size="40" value="<%=fichaTecnica.getCodigoConceptoTecnico()%>" disabled="disabled"/></td-->
    			</tr>
    			<tr>
					<td>Descripción :</td>
				  <td width="242"><input name = "descripcion" type="type" size="40" value="<%=fichaTecnica.getDescripcionFichaTecnica()%>" disabled="disabled"/></td>
				</tr>
				<tr>
			<td></td>
	        <td></td>
