	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="370">
				<tr>
				<td><form action="consultar_fichatecnica.jsp" method="get" onSubmit = "return validar(this)" name="fichatecnica">
				<table width="362">
					<tr>
			  			<td width="140">Código del Produto :</td>
      					<td width="152"><input name = "producto" type="type"/></td>
						<td width="54"><input type="submit" name="buscar" value="Buscar"/></td>
	  				</tr>
				</table>
				</form></td>
				</tr>
