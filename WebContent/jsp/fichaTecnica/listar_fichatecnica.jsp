	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Ficha Tecnica</h1></td>
				<td width="64"><button type="button" onClick="window.open('fichatecnica.jsp','_self')">Atr&aacute;s</button></td>
				<!--td width="47"><button type="button" onClick="window.open('listar_conceptotecnico.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="fichatecnica.jsp">
					<input type="submit" name="fichatecnica" value="Ficha Tecnica"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				<tr><th>Producto</th><th>Concepto T&eacute;cnico</th><th>Descripci&oacute;n</th></tr>
				<%ManejadorFichaTecnica manFichaTecnica = new ManejadorFichaTecnica();%>
				<%Vector vecRep;
				vecRep = manFichaTecnica.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	FichaTecnica fichaTecnica = (FichaTecnica) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=fichaTecnica.getCodigoProducto()%></td>
      					<td width="110" align="right">&nbsp;<%=fichaTecnica.getCodigoConceptoTecnico()%></td>
						<td width="10" align="left">&nbsp;<%=fichaTecnica.getDescripcionFichaTecnica()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
