...
var checkOK = "0123456789";
  ...
  if (formulario.conceptotecnico.value.length < 1) {
    alert("Escriba el Código Concepto Tecnico.");
...
<table>
	...
	<form method = "get" name = "fichatecnica_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaFichaTecnica">
  				<input name = "producto" type="hidden" value="<%=fichaTecnica.getCodigoProducto()%>"/>
				<table>
				<tr>
					<td width="133">C&oacute;digo Producto :</td>
   				  <td width="242"><input name = "producto2" type="type" value="<%=fichaTecnica.getCodigoProducto()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Código Concepto Técnico :</td>
			   ...
			   <td><SELECT size="1" name="conceptotecnico">
			    ...
			    <%}%>
	   			    ...
	   			    <!--td width="242"><input name = "conceptotecnico" type="type" size="40" value="<%=fichaTecnica.getCodigoConceptoTecnico()%>"/></td-->
				</tr>
    			<tr>
					<td>Descripción :</td>
				  <td width="242"><input name = "descripcion" type="type" size="40" value="<%=fichaTecnica.getDescripcionFichaTecnica()%>"/></td>
				</tr>
				<tr>
			<td></td>
	        <td></td>
