...
<%session.removeAttribute("arrayIngredienteEntrega");%>
...
<button type="button" onClick="window.open('/LaPalmera/jsp/UsoSistema.jsp?destino=ListaOrdenFabricacionEntregaInsumo.jsp&titulo=Lista Orden Fabricación&filordenfabricacion=<%=filordenfabricacion%>','_self')">Volver</button>
</form>
</body>
</html>
<%if (mensaje.length() > 0){%>
