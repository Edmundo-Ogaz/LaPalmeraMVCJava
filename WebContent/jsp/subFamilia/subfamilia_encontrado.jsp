	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_subfamilia.jsp" onSubmit="return validar(this)">
  				<input name = "cod" type="hidden" value="<%=subfamilia.getCodigoSubfamilia()%>"/>
				<table>
				<tr>
					<td width="133">C&oacute;diga Subfamilia :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=subfamilia.getCodigoSubfamilia()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
					
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=subfamilia.getNombreSubfamilia()%>" disabled="disabled"/></td>
    			</tr>
    			<tr>
		   ...
		   <%}%>
				  ...
				  <!--td width="242"><input name = "familia" type="type" size="40" value="<%=subfamilia.getCodigoFamilia()%>" disabled="disabled"/></td-->
