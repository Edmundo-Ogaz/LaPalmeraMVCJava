...
<!--table background="images/pasteleria_fondo3.3.png" cellpadding="0" cellspacing="0" width="752"  height="582"class="Middle"-->
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaSubfamilia">
  				<input name = "codigo" type="hidden" value="<%=subfamilia.getCodigoSubfamilia()%>"/>
				<table>
				<tr>
			  			<td width="153">Código Subfamilia :</td>
						<td width="240"><input name = "codigo2" type="type" value="<%=subfamilia.getCodigoSubfamilia()%>" disabled="disabled"/></td>
				<tr>
			      <td width="153">Nombre :</td>
	   			<td width="240"><input name = "nombre" type="type" size="40"/></td>
    			</tr>
			<tr>
			<td valign="top">Código Familia</td>
			<%ManejadorFamilia manFamilia = new ManejadorFamilia();%>
			<%Vector vecRep4;
			vecRep4 = manFamilia.consultar();%>
			<%Enumeration enumRep4 = vecRep4.elements();%>
			   <td><SELECT size="1" name="familia">
			  <%while (enumRep4.hasMoreElements())
    			{
		     Familia familia = (Familia) enumRep4.nextElement();%>
	  ...
	  <td width="81"><input name="cancelar" value="Cancelar" type="button"></td>
    </tr>
  </table>
</form>
	</td>
