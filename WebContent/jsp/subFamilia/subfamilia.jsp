	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td width="351"><form action="consultar_subfamilia.jsp" method="get" onSubmit = "return validar(this)" name="subfamilia">
				<table width="350">
					<tr>
			  			<td width="122">Código Subfamilia :</td>
      					<td width="144"><input name = "codigo" type="type"/></td>
