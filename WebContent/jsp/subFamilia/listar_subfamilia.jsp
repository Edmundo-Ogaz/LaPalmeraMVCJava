	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="47"><button type="button" onClick="window.open('listar_subfamilia.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="subfamilia.jsp">
					<input type="submit" name="subfamilia" value="Subfamilia"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				<tr><th>C&oacute;digo</th><th>Nombre</th><th>Familia</th></tr>
				...
				<%while (itSubfamilia.hasNext())
			    {
			    	...
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=subfamilia.getCodigoSubfamilia()%></td>
      					<td width="110" align="left">&nbsp;<%=subfamilia.getNombreSubfamilia()%></td>
						<td width="10" align="right">&nbsp;<%=subfamilia.getCodigoFamilia()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
