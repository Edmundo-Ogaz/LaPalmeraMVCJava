...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaInsumo">
  				<input name = "codigo" type="hidden" value="<%=insumo.getCodigoInsumo()%>"/>
				<table>
				<tr>
			  			<td width="116">Código Insumo :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=insumo.getCodigoInsumo()%>" disabled="disabled"/></td>
				<tr>
		   ...
		   <%}%>
			...
			<td colspan="3"><TEXTAREA name="observacion" rows = 5 cols = 60></TEXTAREA></td>
			</tr>
			<tr>
			<td></td>
	        <td></td>
