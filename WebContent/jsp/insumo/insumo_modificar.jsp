...
<table>
	...
	<form method = "get" name = "insumo_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaInsumo">
  				<input name = "codigo" type="hidden" value="<%=insumo.getCodigoInsumo()%>"/>
				<table>
				<tr>
					<td width="133">Código Insumo :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=insumo.getCodigoInsumo()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=insumo.getNombreInsumo()%>"/></td>
				</tr>
    			<tr>
				<td>Código Unidad de medida</td>
		   ...
		   <%}%>
				...
				<!--td width="242"><input name = "unidadmedida" type="type" size="40" value="<%=insumo.getCodigoUnidadMedida()%>"/></td-->
				</tr>
				<tr>
				<td width="157">Stock Critico</td>
				<td><input name = "stockcritico" type="type" value="<%=insumo.getStockCriticoInsumo()%>"/></td>
				</tr>
				<tr>
				<td valign="top">Observación</td>
				<td colspan="3"><TEXTAREA name="observacion" rows = 5 cols = 60><%=insumo.getObservacionInsumo()%></TEXTAREA></td>
	   			<!--td><input name = "observacion" type="type" value="<%=insumo.getObservacionInsumo()%>"/></td-->
				</tr>
				<tr>
				<td></td>
	        	<td></td>
