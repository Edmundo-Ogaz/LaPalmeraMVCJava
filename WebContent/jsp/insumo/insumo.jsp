...
var checkOK = "0123456789";
  ...
  if (!allValid) {
    alert("Escriba sólo números en el campo \"Código Insumo\".");
    formulario.codigo.focus();
    return (false);
  }    
    return (true);
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td><form action="consultar_insumo.jsp" method="get" onSubmit = "return validar(this)" name="insumo">
				<table>
					<tr>
			  			<td width="116">Código Insumo :</td>
      					<td width="150"><input name = "codigo" type="type"/></td>
