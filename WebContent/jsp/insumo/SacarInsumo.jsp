...
<%
		...
		{
		arrayIngredienteEntrega.remove(cantidaddevolucion-2);
		}
%>
<table border="1">
...
int j = 0;
int i = 1;
Iterator itIngrediente = arrayIngredienteEntrega.iterator();
...
<select size="1" name="unidadmedida<%=i%>" disabled="disabled">
...
<input type="hidden" name="cantidadentrega" value="<%=j%>"/>
