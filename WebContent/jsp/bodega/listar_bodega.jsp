	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="47"><button type="button" onClick="window.open('listar_bodega.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="bodega.jsp">
					<input type="submit" name="bodega" value="Bodega"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				...
				<%Vector vecRep;
				vecRep = manBodega.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	Bodega bodega = (Bodega) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=bodega.getCodigoBodega()%></td>
      					<td width="110" align="left">&nbsp;<%=bodega.getNombreBodega()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
