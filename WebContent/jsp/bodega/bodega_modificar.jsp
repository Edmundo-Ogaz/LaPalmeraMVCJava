...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el código de l Bodega.");
...
<!--able background="images/pasteleria_fondo3.3.png" cellpadding="0" cellspacing="0" width="752"  height="582"class="Middle"-->
<table>
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Bodega</h1></td>
				<td width="64"><button type="button" onClick="window.open('bodega.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_bodega.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_bodega.jsp">
	...
	<form method = "get" name = "bodega_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaBodega">
  				<input name = "codigo" type="hidden" value="<%=bodega.getCodigoBodega()%>"/>
				<table>
				<tr>
					<td width="133">Código Bodega :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=bodega.getCodigoBodega()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=bodega.getNombreBodega()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
