...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaBodega">
  				<input name = "codigo" type="hidden" value="<%=bodega.getCodigoBodega()%>"/>
				<table>
				<tr>
			  			<td width="116">Código Bodega :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=bodega.getCodigoBodega()%>" disabled="disabled"/></td>
				<tr>
