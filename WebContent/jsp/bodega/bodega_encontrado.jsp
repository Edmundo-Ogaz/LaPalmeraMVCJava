	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_bodega.jsp" onSubmit = "return validar(this)">
  				<input name = "cod" type="hidden" value="<%=bodega.getCodigoBodega()%>"/>
				<table>
				<tr>
					<td width="133">Código Bodega :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=bodega.getCodigoBodega()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=bodega.getNombreBodega()%>" disabled="disabled"/></td>
    			</tr>
			<tr>
			<td></td>
	        <td></td>
