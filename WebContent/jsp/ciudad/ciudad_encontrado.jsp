	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_ciudad.jsp" onSubmit="return validar(this)">
  				<table>
				<tr>
					<td width="133">C&oacute;digo Ciudad :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=ciudad.getCodigoCiudad()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=ciudad.getNombreCiudad()%>" disabled="disabled"/></td>
    			</tr>
    			<tr>
					<td>Regin :</td>
			   ...
			   <td><SELECT size="1" name="ciudad" disabled="disabled">
			    ...
			    <%}%>
				  ...
				  <!--td width="242"><input name = "region" type="type" size="40" value="<%=ciudad.getCodigoRegion()%>" disabled="disabled"/></td-->
				</tr>
			<tr>
			<td></td>
	        <td></td>
	  ...
	  <input name="cod" type="hidden" value="<%=ciudad.getCodigoCiudad()%>"/>
    </tr>
  </table>
</form>
	</td>
