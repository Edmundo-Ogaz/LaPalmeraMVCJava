...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaCiudad">
  				<input name = "codigo" type="hidden" value="<%=ciudad.getCodigoCiudad()%>"/>
				<table>
				<tr>
			  			<td width="116">C&oacute;digo Ciudad :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=ciudad.getCodigoCiudad()%>" disabled="disabled"/></td>
				<tr>
