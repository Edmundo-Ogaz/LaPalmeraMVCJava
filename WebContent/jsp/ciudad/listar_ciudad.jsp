	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="50"><form action="ciudad.jsp">
					<input type="submit" name="ciudad" value="Ciudad"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				<tr><th>C&oacute;digo</th><th>Nombre</th><th>Regi&oacute;n</th></tr>
				<%ManejadorCiudad manCiudad = new ManejadorCiudad();%>
				<%Vector vecRep;
				vecRep = manCiudad.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	Ciudad ciudad = (Ciudad) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="left">&nbsp;<%=ciudad.getCodigoCiudad()%></td>
      					<td width="110" align="right">&nbsp;<%=ciudad.getNombreCiudad()%></td>
						<td width="10" align="right">&nbsp;<%=ciudad.getCodigoRegion()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
