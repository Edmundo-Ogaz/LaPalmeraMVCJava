...
<table>
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Región</h1></td>
				<td width="64"><button type="button" onClick="window.open('region.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_region.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_region.jsp">
	...
	<form method = "get" name = "region_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaRegion">
  	<input name="codigo" type="hidden" value="<%=region.getCodigoRegion()%>">
  				<table>
				<tr>
					<td width="133">C&oacute;digo Regi&oacute;n :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=region.getCodigoRegion()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=region.getNombreRegion()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
