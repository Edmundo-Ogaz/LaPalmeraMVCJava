...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaRegion">
  				<input name = "codigo" type="hidden" value="<%=region.getCodigoRegion()%>"/>
  				<table>
				<tr>
			  			<td width="116">C&oacute;digo Regi&oacute;n :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=region.getCodigoRegion()%>" disabled="disabled"/></td>
				<tr>
