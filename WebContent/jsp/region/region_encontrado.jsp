	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Regi&oacute;n</h1></td>
				...
				<form method = "get" action = "consultar_operacion_region.jsp" onSubmit="return validar(this)">
  				<table>
				<tr>
					<td width="133">C&oacute;digo Regi&oacute;n :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=region.getCodigoRegion()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=region.getNombreRegion()%>" disabled="disabled"/></td>
    			</tr>
    			<tr>
			<td></td>
	        <td></td>
	  ...
	  <input name="cod" type="hidden" value="<%=region.getCodigoRegion()%>"/>
    </tr>
  </table>
</form>
	</td>
