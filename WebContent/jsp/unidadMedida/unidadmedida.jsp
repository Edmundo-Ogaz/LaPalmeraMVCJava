	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td><form action="consultar_unidadmedida.jsp" method="get" onSubmit = "return validar(this)" name="funcionario">
				<table width="417">
					<tr>
			  			<td width="195">C&oacute;digo Unidad Medida :</td>
      					<td width="152"><input name = "codigo" type="type"/></td>
