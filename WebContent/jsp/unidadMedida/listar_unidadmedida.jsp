	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="50"><form action="unidadmedida.jsp">
					<input type="submit" name="unidadmedida" value="Unidad Medida"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				...
				<%Vector vecRep;
				vecRep = manUnidadMedida.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	UnidadMedida unidadMedida = (UnidadMedida) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=unidadMedida.getCodigoUnidadMedida()%></td>
      					<td width="110" align="left">&nbsp;<%=unidadMedida.getNombreUnidadMedida()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
