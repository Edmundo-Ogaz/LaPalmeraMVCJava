...
<table>
	...
	<form method = "get" name = "unidadmedida_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaUnidadMedida">
  				<input name = "codigo" type="hidden" value="<%=unidadMedida.getCodigoUnidadMedida()%>"/>
				<table>
				<tr>
					<td width="133">Código Unidad Medida :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=unidadMedida.getCodigoUnidadMedida()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=unidadMedida.getNombreUnidadMedida()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
