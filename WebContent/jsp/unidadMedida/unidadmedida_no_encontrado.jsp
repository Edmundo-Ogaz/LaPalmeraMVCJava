...
var checkOK = "0123456789";
  ...
  if (formulario.nombre.value.length < 1) {
    alert("Escriba el nombre de la Unidad Medida.");
...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaUnidadMedida">
  				<input name = "codigo" type="hidden" value="<%=unidadMedida.getCodigoUnidadMedida()%>"/>
				<table>
				<tr>
			  			<td width="116">Código Unidad Medida :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=unidadMedida.getCodigoUnidadMedida()%>" disabled="disabled"/></td>
				<tr>
