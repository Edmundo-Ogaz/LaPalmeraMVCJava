	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="47"><button type="button" onClick="window.open('listar_familia.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="familia.jsp">
					<input type="submit" name="familia" value="Familia"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
			    ...
			    { 
			    	...
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=familia.getCodigoFamilia()%></td>
      					<td width="110" align="left">&nbsp;<%=familia.getNombreFamilia()%></td>
