...
<table>
	<tr height="1">
		...
		<td valign="top">
			...
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaFamilia">			
			<input name = "codigo" type="hidden" value="<%=familia.getCodigoFamilia()%>"/>
  				<table>
				<tr>
			  			<td width="116">Cógido Familia :</td>
						<td width="150"><input name = "codigo2" type="type" value="<%=familia.getCodigoFamilia()%>" disabled="disabled"/></td>
				<tr>
