...
<table>
	...
	<form method = "get" name = "familia_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaFamilia">
  				<input name = "codigo" type="hidden" value="<%=familia.getCodigoFamilia()%>"/>
				<table>
				<tr>
					<td width="133">Código Familia :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=familia.getCodigoFamilia()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=familia.getNombreFamilia()%>"/></td>
				</tr>
			<tr>
			<td></td>
	        <td></td>
