...
<body topmargin="0" leftmargin="0" onLoad="MM_preloadImages('menu_pasteleria/imgenes/menu_pasteleria_r1_c1.gif','menu_pasteleria/imgenes/menu_pasteleria_r1_c2_f2.gif','menu_pasteleria/imgenes/menu_pasteleria_r1_c2.gif','menu_pasteleria/imágenes/menu_pasteleria_r1_c4_f2.gif','menu_pasteleria/imgenes/menu_pasteleria_r1_c4.gif','menu_pasteleria/imgenes/menu_pasteleria_r1_c6_f2.gif','menu_pasteleria/imgenes/menu_pasteleria_r1_c6.gif','menu_pasteleria/imgenes/menu_pasteleria_r1_c8_f2.gif','menu_pasteleria/imgenes/menu_pasteleria_r1_c8.gif');">
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Familia</h1></td>
				<td width="64"><button type="button" onClick="window.open('familia.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_familia.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_familia.jsp">
				...
				<form method = "get" action = "consultar_operacion_familia.jsp" onSubmit="return validar(this)">
  				<input name = "cod" type="hidden" value="<%=familia.getCodigoFamilia()%>"/>
				<table>
				<tr>
					<td width="133">Código Familia :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=familia.getCodigoFamilia()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=familia.getNombreFamilia()%>" disabled="disabled"/></td>
    			</tr>
			<tr>
			<td></td>
	        <td></td>
