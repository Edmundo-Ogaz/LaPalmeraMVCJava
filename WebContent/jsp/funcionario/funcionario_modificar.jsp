...
<table>
	...
	<form method = "get" name = "funcionario_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaFuncionario">
  				<input name = "rut" type="hidden" value="<%=funcionario.getRutFuncionario()%>"/>
  				<table>
				<tr>
					<td width="133">Rut Funcionario :</td>
   				  <td width="242"><input name = "rut2" type="type" value="<%=funcionario.getRutFuncionario()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=funcionario.getNombreFuncionario()%>"/></td>
				</tr>
    			<tr>
					<td>Apellido Paterno :</td>
				  <td width="242"><input name = "apellidopaterno" type="type" size="40" value="<%=funcionario.getApellidoPaternoFuncionario()%>"/></td>
				</tr>
				<tr>
				<td>Apellido Materno :</td>
				<td width="242"><input name = "apellidomaterno" type="type" size="40" value="<%=funcionario.getApellidoMaternoFuncionario()%>"/></td>
				</tr>
		   ...
		   <%}%>
				  ...
				  <!--td width="242"><input name = "cargo" type="type" size="40" value="<%=funcionario.getCodigoCargo()%>"/></td-->
			</tr>
			<tr>
		   ...
		   <%}%>
				  ...
				  <!--td width="242"><input name = "area" type="type" size="40" value="<%=funcionario.getCodigoArea()%>"/></td-->
			</tr>
			<tr>
			<td></td>
	        <td></td>
