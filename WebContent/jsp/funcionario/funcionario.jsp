	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td><form action="consultar_funcionario.jsp" method="get" onSubmit = "return validar(this)" name="funcionario">
				<table>
					<tr>
			  			<td width="116">Rut Funcionario :</td>
      					<td width="150"><input name = "rut" type="type"/></td>
