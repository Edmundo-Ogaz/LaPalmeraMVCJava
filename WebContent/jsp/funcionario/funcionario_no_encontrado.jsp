...
<table>
	...
	<form method = "get" name = "funcionario_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaFuncionario">
    			...
    			<tr>
				  ...
				  <td width="242"><input name = "apellidopaterno" type="type" size="40" /></td>
				</tr>
				<tr>
				<td>Apellido Materno :</td>
				<td width="242"><input name = "apellidomaterno" type="type" size="40" /></td>
				</tr>
