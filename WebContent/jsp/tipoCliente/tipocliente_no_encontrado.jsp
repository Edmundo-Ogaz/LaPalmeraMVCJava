...
function validar(formulario) {
  if (formulario.codigo.value.length < 1) {
    alert("Escriba el código del Tipo Cliente.");
...
var checkOK = "0123456789";
  ...
  if (formulario.nombre.value.length < 1) {
    alert("Escriba el nombre del Tipo Cliente.");
	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table width="676">
				<tr>
				<td width="611"><h1>Mantenedor Tipo Cliente</h1></td>
				<td width="64"><button type="button" onClick="window.open('tipocliente.jsp','_self')">Atr&aacute;s</button></td>
				<td width="47"><button type="button" onClick="window.open('listar_tipocliente.jsp','_self')">Listar</button></td>
				<!--td width="50"><form action="listar_tipocliente.jsp">
					<input type="submit" name="listar" value="Listar"/>
				  </form></td-->
				</tr>
				</table>
			<jsp:useBean id="tipoCliente" class="TipoCliente" scope="session"/>
			<form method = "get" name = "ingreso_Formulario" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/GrabaTipoCliente">
  				<input name="codigo" type="hidden" value="<%=tipoCliente.getCodigoTipoCliente()%>">
  				<table width="559">
				<tr>
			  			<td width="153">C&oacute;digo Tipo Cliente :</td>
						<td width="251"><input name = "codigo2" type="type" value="<%=tipoCliente.getCodigoTipoCliente()%>" disabled="disabled"/></td>
				<tr>
			      <td width="153">Nombre :</td>
	   			<td width="251"><input name = "nombre" type="type" size="40"/></td>
    			</tr>
			<tr>
			<td></td>
	        <td></td>
	  <td width="55"><input name="grabar" value="Grabar" type="submit"></td>
	  <td width="80"><input name="cancelar" value="Cancelar" type="button"></td>
    </tr>
  </table>
</form>
	</td>
