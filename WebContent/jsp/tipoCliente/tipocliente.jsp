	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<table>
				<tr>
				<td><form action="consultar_tipocliente.jsp" method="get" onSubmit = "return validar(this)" name="tipocliente">
				<table width="375">
					<tr>
			  			<td width="133" valign="">C&oacute;digo Tipo Cliente :</td>
      					<td width="151"><input name = "codigo" type="type"/></td>
						<td width="75"><input type="submit" name="buscar" value="Buscar"/></td>
	  				</tr>
				</table>
				</form></td>
				</tr>
