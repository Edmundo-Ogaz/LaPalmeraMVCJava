	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<!--td width="47"><button type="button" onClick="window.open('listar_tipocliente.jsp','self')">Listar</button></td-->
				<!--td width="50"><form action="tipocliente.jsp">
					<input type="submit" name="tipocliente" value="Tipo Cliente"/>
				  </form></td-->
				</tr>
				</table>
				<table border="1">
				...
				<%Vector vecRep;
				vecRep = manTipoCliente.consultar();%>
				<%Enumeration enumRep = vecRep.elements();%>
				<%while (enumRep.hasMoreElements())
			    {
			    	TipoCliente tipoCliente = (TipoCliente) enumRep.nextElement();%>
			    	<tr>
			  			<td width="20" align="right">&nbsp;<%=tipoCliente.getCodigoTipoCliente()%></td>
      					<td width="110" align="left">&nbsp;<%=tipoCliente.getNombreTipoCliente()%></td>
						<td></td>
	  				</tr>
				<%}%>
				</table>
