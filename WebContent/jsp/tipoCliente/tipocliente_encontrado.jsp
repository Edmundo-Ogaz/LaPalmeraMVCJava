	...
	<tr height="1">
		...
		<td valign="top">
			<table cellpadding="0" cellspacing="0" height="100%">
				...
				<form method = "get" action = "consultar_operacion_tipocliente.jsp" onSubmit="return validar(this)">
  				<input name="cod" type="hidden" value="<%=tipoCliente.getCodigoTipoCliente()%>">
  				<table>
				<tr>
					<td width="133">C&oacute;digo Tipo Cliente :</td>
   				  <td width="242"><input name = "codigo" type="type" value="<%=tipoCliente.getCodigoTipoCliente()%>" disabled="disabled" /></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			  <td width="242"><input name = "nombre" type="type" size="40" value="<%=tipoCliente.getNombreTipoCliente()%>" disabled="disabled"/></td>
    			</tr>
			<tr>
			<td></td>
	        <td></td>
