...
<table>
	...
	<form method = "get" name = "tipocliente_modificar" onSubmit = "return validar(this)" action = "/LaPalmera/servlet/ModificaTipoCliente">
  				<input name = "codigo" type="hidden" value="<%=tipoCliente.getCodigoTipoCliente()%>"/>
  				<table>
				<tr>
					<td width="133">C&oacute;digo Tipo Cliente :</td>
   				  <td width="242"><input name = "codigo2" type="type" value="<%=tipoCliente.getCodigoTipoCliente()%>" disabled="disabled"/></td>
				</tr>
				<tr>
					<td width="133">Nombre :</td>
	   			    <td width="242"><input name = "nombre" type="type" size="40" value="<%=tipoCliente.getNombreTipoCliente()%>"/></td>
				</tr>
    		<tr>
			<td></td>
	        <td></td>
