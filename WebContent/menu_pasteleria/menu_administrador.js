...
function mmLoadMenus() {
  if (window.mm_menu_0328002410_0) return;
    ...
    mm_menu_0328002410_0.addMenuItem("Comunas","location='UsoSistema.jsp?destino=comuna/FilComuna.jsp&titulo=Filtrado de Comuna'");
    mm_menu_0328002410_0.addMenuItem("Ciudades","location='UsoSistema.jsp?destino=ciudad/FilCiudad.jsp&titulo=Filtrado de Ciudad'");
    mm_menu_0328002410_0.addMenuItem("Regiones","location='UsoSistema.jsp?destino=region/FilRegion.jsp&titulo=Filtrado de Región'");
    mm_menu_0328002410_0.addMenuItem("Cargos","location='UsoSistema.jsp?destino=cargo/FilCargo.jsp&titulo=Filtrado de Cargo'");
    mm_menu_0328002410_0.addMenuItem("&Aacute;reas","location='UsoSistema.jsp?destino=Area/FilArea.jsp&titulo=Filtrado de Area'");
    mm_menu_0328002410_0.addMenuItem("Funcionarios","location='UsoSistema.jsp?destino=funcionario/FilFuncionario.jsp&titulo=Filtrado de Funcionario'");
    ...
    mm_menu_0328002410_0.addMenuItem(mm_menu_0328002410_0_3);
     ...
     mm_menu_0328002410_0.childMenuIcon="../menu_pasteleria/imgenes/arrows.gif";
	...
	mm_menu_0328002410_1_1.addMenuItem("Confirmaci&oacute;n&nbsp;Pedidos","location='UsoSistema.jsp?destino=ListaConfirmarPedido.jsp&titulo=Pedidos para Confirmar'");
    ...
    mm_menu_0328002410_1.addMenuItem("Programas&nbsp;de&nbsp;Producci&oacute;n","location='UsoSistema.jsp?destino=FilProgramaProduccion.jsp&titulo=Filtrado Programa de Producción'");
    ...
    mm_menu_0328002410_2.addMenuItem("Pedidos","location='UsoSistema.jsp?destino=FilPedido.jsp&titulo=Filtrado Informe Pedidos'");
	mm_menu_0328002410_2.addMenuItem("Ordenes&nbsp;de&nbsp;Fabricación","location='UsoSistema.jsp?destino=FilInformeOrdenFabricacion.jsp&titulo=Filtrado Informe Orden Fabricación'");
    mm_menu_0328002410_2.addMenuItem("Entrega&nbsp;Insumos&nbsp;por&nbsp;O.F.","location='UsoSistema.jsp?destino=FilInformeEntregaInsumo.jsp&titulo=Filtrado Informe Entrega de Insumos'");
	mm_menu_0328002410_2.addMenuItem("Devolución&nbsp;Insumos&nbsp;por&nbsp;O.F.","location='UsoSistema.jsp?destino=FilInformeDevolucionInsumo.jsp&titulo=Filtrado Informe Devolución de Insumos'");
	mm_menu_0328002410_2.addMenuItem("Captura&nbsp;Producci&oacute;n&nbsp;por&nbsp;O.F.","location='UsoSistema.jsp?destino=FilInformeCapturaProduccion.jsp&titulo=Filtrado Informe Captura Producción'");
	mm_menu_0328002410_2.addMenuItem("Determinar&nbsp;Insumos","location='UsoSistema.jsp?destino=FilInformeDeterminarInsumo.jsp&titulo=Filtrado Determinar Insumos'");
