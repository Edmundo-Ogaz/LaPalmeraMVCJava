...
public static void main(String args[]) {
	...
	//Crea Clase
        try 
	 {
	  ...
	  lineasalida.write("package unab.com;");
          lineasalida.newLine();
	  lineasalida.write("import java.sql.*;");
          lineasalida.newLine();
	  lineasalida.write("public class "+nombreClase);
          lineasalida.newLine();
	  lineasalida.write("  { ");
          lineasalida.newLine();
	  ...
	  while (lista.hasMoreElements())
	     ...
	     Elementos e = (Elementos) lista.nextElement();
 	     ...
 	     lineasalida.write("      public void grabar()");
  	     ...
  	     lineasalida.write("        String login = \"root\";");
  	     lineasalida.newLine();
  	     
  	     lineasalida.write("        String password = \"jochua\";");
  	     lineasalida.newLine();
  	     
  	     lineasalida.write("        String url = \"jdbc:mysql://localhost/palmera\";");
  	     lineasalida.newLine();
  	     ...
  	     lineasalida.newLine();
  	     lineasalida.write("              Class.forName(\"com.mysql.jdbc.Driver\").newInstance();");
  	     lineasalida.newLine();
  	     lineasalida.write("              conn =");
  	     lineasalida.write(" DriverManager.getConnection(url,login,password);");
  	     lineasalida.newLine();
  	     
  	     lineasalida.write("      	 if (conn != null)");
  	     lineasalida.newLine();
  	     ...
  	     lineasalida.write("              Statement stmt = conn.createStatement();");
  	     lineasalida.newLine();
	     ...
	     else
		{
		 ...
		 e.getTipoDeDatos().equals("c") || e.getTipoDeDatos().equals("C"))
	         ...
	         else
		  {
  	     ...
  	     lineasalida.write("              //LOGGER.debug(sql);");
  	     lineasalida.newLine();
  	     
  	     lineasalida.write("              int i = stmt.executeUpdate(sql);");
  	     lineasalida.newLine();
  	     
  	     lineasalida.write("               if (i == 1)");
  	     lineasalida.newLine();
  	     
  	     lineasalida.write("              //System.out.println(\"OK\");");
  	     lineasalida.newLine(); 
  	     
  	     lineasalida.write("              stmt.close();");
  	     lineasalida.newLine();
  	     lineasalida.write("              conn.close();");
  	     lineasalida.newLine();
  	     lineasalida.write("             }");
  	     lineasalida.newLine();
	...
	//Crea Manejador
        try 
	 {
	  ...
	  lineasalida.write("import java.util.*;");
          lineasalida.newLine();
	  lineasalida.write("public class Manejador"+nombreClase);
          lineasalida.newLine();
	  lineasalida.write("  { ");
          lineasalida.newLine();
 	  Enumeration lista = vec.elements();
	  ...
	  while (lista.hasMoreElements())
	     ...
	     Elementos e = (Elementos) lista.nextElement();
 	     ...
 	     lineasalida.write("      public Vector consultar()");
  	     lineasalida.newLine();
  	     lineasalida.write("        {");
  	     lineasalida.newLine();
	  ...
	  while (lista.hasMoreElements())
		 ...
		 lineasalida.write("              ");
  	     ...
  	     lineasalida.write("               ResultSet rs = stmt.executeQuery(sql);");
  	     lineasalida.newLine();
