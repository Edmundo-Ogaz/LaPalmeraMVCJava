...
public class ModificaSubfamilia extends HttpServlet
{

    public ModificaSubfamilia()
    {
    }
        ...
        throws IOException, ServletException
    {
	    ...
	    if (opcion.equals("Enviar"))
          ...
          subfamilia.modificar();
          } 
	       
		httpservletresponse.sendRedirect(enviara);
        //httpservletresponse.sendRedirect("http://localhost:8080/LaPalmera/jsp/subfamilia.jsp");
